 ...
 */
    ...
    LAYOUT_directional(
        ...
        ______, RGB_TOG, RGB_MOD, RGB_HUI, RGB_HUD, RGB_SAI, RGB_SAD, RGB_VAI, RGB_VAD, KC_TRNS, ______, ______, ______, ______,
        ______, KC_MPLY, KC_VOLD, KC_VOLU, KC_MPRV, KC_MNXT, ______, ______, ______, ______, ______, ______,

...
_RGBM_MULTI_STATIC(STATIC_NONRAINBOW)
_RGBM_TMP_STATIC(static_nonrainbow_1, STATIC_NONRAINBOW)
_RGBM_TMP_STATIC(static_nonrainbow_2, STATIC_NONRAINBOW)
_RGBM_TMP_STATIC(static_nonrainbow_3, STATIC_NONRAINBOW)
_RGBM_TMP_STATIC(static_nonrainbow_4, STATIC_NONRAINBOW)
_RGBM_TMP_STATIC(static_nonrainbow_5, STATIC_NONRAINBOW)
_RGBM_TMP_STATIC(static_nonrainbow_6, STATIC_NONRAINBOW)
_RGBM_TMP_STATIC(static_nonrainbow_7, STATIC_NONRAINBOW)
_RGBM_TMP_STATIC(STATIC_NONRAINBOW_end, STATIC_NONRAINBOW)
#    endif
#    ifdef RGBLIGHT_EFFECT_STATIC_COMPLEMENTARY
_RGBM_MULTI_STATIC(STATIC_COMPLEMENTARY)
_RGBM_TMP_STATIC(static_complementary_1, STATIC_COMPLEMENTARY)
_RGBM_TMP_STATIC(static_complementary_2, STATIC_COMPLEMENTARY)
_RGBM_TMP_STATIC(static_complementary_3, STATIC_COMPLEMENTARY)
_RGBM_TMP_STATIC(static_complementary_4, STATIC_COMPLEMENTARY)
_RGBM_TMP_STATIC(static_complementary_5, STATIC_COMPLEMENTARY)
_RGBM_TMP_STATIC(static_complementary_6, STATIC_COMPLEMENTARY)
_RGBM_TMP_STATIC(static_complementary_7, STATIC_COMPLEMENTARY)
_RGBM_TMP_STATIC(static_complementary_8, STATIC_COMPLEMENTARY)
_RGBM_TMP_STATIC(static_complementary_9, STATIC_COMPLEMENTARY)
_RGBM_TMP_STATIC(static_complementary_10, STATIC_COMPLEMENTARY)
_RGBM_TMP_STATIC(static_complementary_12, STATIC_COMPLEMENTARY)
_RGBM_TMP_STATIC(static_complementary_13, STATIC_COMPLEMENTARY)
_RGBM_TMP_STATIC(static_complementary_14, STATIC_COMPLEMENTARY)
_RGBM_TMP_STATIC(static_complementary_15, STATIC_COMPLEMENTARY)
_RGBM_TMP_STATIC(STATIC_COMPLEMENTARY_end, STATIC_COMPLEMENTARY)
#    endif
